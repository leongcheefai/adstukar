...
export { AdCard, AD_CARD_DIMENSIONS, AD_CARD_SCALE, adCardDimensions } from "./patterns/ad-card";
export type { AdCardFormat, AdCardProps, AdCardSize } from "./patterns/ad-card";
