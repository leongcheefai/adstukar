...
- **Nothing is priced when a play is served** — the daily cap, the state of the slot, the campaign, and the listing are all read at report time. Above the cap, or on a creative an admin rejected after the batch was cut, the play still shows and still counts, and simply pays nothing. A scan is recorded and never paid.
