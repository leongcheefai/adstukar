...
/**
 * Where the lockup links: the landing page. The app never sends a visitor
 * there on its own; a signed-out visitor gets the login form on the set. Null
 * when there is nowhere real to link to, and the lockup is only a mark:
 *
